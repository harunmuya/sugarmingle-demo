...
export function AppProvider({ children }) {
    ...
    useEffect(() => {
        ...
        // Slight delay ensures loading fade animation completes on all browsers & TVs
